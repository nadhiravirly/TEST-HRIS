					...
					<div class="card-body">
						...
						<form action="<?php base_url('admin/product/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('in') ? 'is-invalid':'' ?>" type="datetime-local" name="in" />
							...
							<div class="form-group">
								...
								<input class="form-control" type="datetime-local" name="out"/>
							</div>
